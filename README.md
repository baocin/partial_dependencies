...
Example
-----------
![Example Dependency Graph](https://raw.githubusercontent.com/baocin/partial_dependencies/master/example/partial_dependencies-used.png)
Example was run on https://github.com/huginn/huginn (Commit #600b06c)

Installation
------------

Update the RAILS_ROOT variable (first line of the PartialDependencies class)
Copy the rake file to your_project/lib/tasks
...
it will generate a file called partial_dependencies-used.png (provided that Graphviz is installed) in your RAILS_ROOT.
